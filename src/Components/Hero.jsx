...
function Hero() {
  return (
    <div className='h-[100vh] w-full bg-blue-500 md:flex md:flex-row-reverse md:h-[85vh]' >
        ...
        <div className='h-[40%] w-full bg-[#FFE4CF] pt-6 pl-4 md:h-full md:w-[50%] md:flex md:justify-center  md:flex-col md:pl-12 xl:pl-25 xl:pb-25  font-[Geologica]'>
            <h1 className='text-[26px] font-black leading-8 md:text-[38px] md:leading-12 md:w-60 lg:w-100 xl:w-120'>Art-inspired home goods for your everyday</h1>
